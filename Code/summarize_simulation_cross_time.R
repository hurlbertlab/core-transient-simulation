## This script is used to summarize multiple runs from a Core-Transient Simulation across time to examine convergence.
...
## Summarizes simulation in time windows defined in parameter file and saves results to directory with _T<end time> appended.
